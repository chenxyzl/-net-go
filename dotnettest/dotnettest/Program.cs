...
namespace cc
{
    class A
    {
        static public void Main()
        {
            ...
            Console.Out.WriteLine($"plugin inner call {a.TestPluginInerCall(new I1())}");
            Console.Out.WriteLine("-------------");
            Console.Out.WriteLine($"plugin outer call {a.TestPluginOuterCall(new I1())}");
            Console.Out.WriteLine("-------------");
            Console.Out.WriteLine($"test invoke call {a.TestInvoke(new I1())}");
        ...
        {
            var asm = Assembly.LoadFile("/home/lin/dotnettest/hotfix/bin/Release/net6.0/hotfix.dll");
